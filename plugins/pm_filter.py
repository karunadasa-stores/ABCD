...
async def next_page(bot, query):
    ...
    btn.insert(0,
               [
                   InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/+N_Nm5J4XQxphMzA1')
               ])
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        try:
            ...
            await query.answer('Please Unblock Bot', show_alert=True)
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🕵️ Search Subtitles Inline 🕵️', switch_inline_query_current_chat='')
            ]]
        reply_markup = InlineKeyboardMarkup(buttons)
        await query.message.edit_text(
        ...
        buttons = [[
            InlineKeyboardButton('Filter', callback_data='manualfilter'),
            InlineKeyboardButton('Group Admins', callback_data='g_admins'),
            InlineKeyboardButton('Users', callback_data='any_user'),
        ],[
            InlineKeyboardButton('Owner', callback_data='admin'),
        ],[
            InlineKeyboardButton('ඔබගේ උපසිරසි අපට ලබාදෙන්න !', callback_data='autofilter')
        ],[
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Source 🔒', callback_data='xsource')
            ],[
